...
(define-public ignis-database-nightly
  (let ((database-night "20220530")
        (database-commit "e3a44056ebaefce80048e942a1e6ee2f85673863")
        (database-hash "0y93pxhip19v2m0bd2hbanzi71alqyqfxsz08hmzd7h0kdx0gnvk")
...
(define-public ignis-scripts-nightly
  (let ((scripts-night "20220602")
        (scripts-commit "ec5527bf94c50549bd54a0816dd4520743da2a34")
        (scripts-hash "15iylzv8s6igpkbi9s39hrqaajp230kw19qcmgdrr29gny895v6v"))
    (package
