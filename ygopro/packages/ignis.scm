...
(define-public ignis-database-nightly
  (let ((database-night "20210808")
        (database-commit "9e80bdb7aebc768cbd9a5f7caaeba5691d87677d")
        (database-hash "0791v692kpjq6viwp4k2fcm8871yzp9bj4zm1bqzx6qzcvcyajrf")
...
(define-public ignis-scripts-nightly
  (let ((scripts-night "20210809")
        (scripts-commit "079543d3cba0ebb15a70a778feca94a0cb9ae744")
        (scripts-hash "1kmykhxnjbigvqbk8k2671kic5nr68bklfwcfn2svy99250vjbsl"))
    (package
